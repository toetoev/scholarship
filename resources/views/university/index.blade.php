						...
						<table class="table table-data2">
							...
							<tbody>
								...
								<tr class="tr-shadow">
									...
									<td>
										<img src="{{asset($university->logo)}}" width="50" height="50">
									</td>
									<td>
										<div class="table-data-feature">
											...
											<form action="{{route('university.destroy', $university->id)}}" method="post" onclick="return confirm('Are u sure to delete!')">
												@csrf
												@method('DELETE')
